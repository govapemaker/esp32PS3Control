...
//        
   ...
   if( abs(Ps3.event.analog_changed.stick.lx) + abs(Ps3.event.analog_changed.stick.ly) > 2 ){
       ...
       Serial.println();
       servo_25.write(map(Ps3.data.analog.stick.lx, -128, 128, 0, 180));
       servo_26.write(map(Ps3.data.analog.stick.ly, -128, 128, 0, 180));
    }
   ...
   if( abs(Ps3.event.analog_changed.stick.rx) + abs(Ps3.event.analog_changed.stick.ry) > 2 ){
       ...
       Serial.println();
       servo_32.write(map(Ps3.data.analog.stick.rx, -128, 128, 0, 180));
       servo_33.write(map(Ps3.data.analog.stick.ry, -128, 128, 0, 180));
   }
